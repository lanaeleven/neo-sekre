...
@section('container')
    <div class="flex flex-col h-screen relative">
        {{-- Navbar --}}
        <x-navbar-form title="Edit Surat Masuk" closeUrl="/surat-masuk/index" />
                ...
                <x-block-input-container>
                    ...
                    <div>
                        <x-dropdown-input :label="'User'" labelPilihan='Pilih User' :name="'idPengirim'" :id="'idPengirim'"
                            ...
                            selectedId="{{ old('pengirim', $suratMasuk->idPengirim ?? '') }}"></x-dropdown-input>
                    </div>
                    ...
                    <div>
                        <x-current-file-input id="fileSurat" label="File Surat" fileName="{{ $suratMasuk->fileName }}"
                            filePath="{{ $suratMasuk->filePath }}" />
                    </div>
