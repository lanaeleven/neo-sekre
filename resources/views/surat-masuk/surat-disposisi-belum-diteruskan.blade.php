...
@section('container')
    <div>
        ...
        <x-title-with-back-button title="surat masuk - belum diteruskan" backUrl="/" />
        
        <div>
            <form class="row g-1" action="/surat-masuk/ns/belum-diteruskan">
                    ...
                    <x-input-field-filter :isLabel="false" name="nomorSurat" type="text" placeholder="nomor surat" :isMedium="true" />
        ...
        @if ($suratMasuk->isEmpty())
            <x-empty-data data='Surat Masuk yang Belum Diteruskan' />
        @else
            ...
            @foreach ($suratMasuk as $sm)
                @php
                    $rows[] = [
                        ...
                        $sm->id .
                        '"class="mt-1 btn btn-warning" style="font-size: 0.8rem; padding: 1px 6px;"><i class="fa-solid fa-share" style="color: #000000;"></i></a>',
                    ];
                @endphp
            @endforeach
            {{-- end set data table --}}
